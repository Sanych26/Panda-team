        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <form method="post" action="/send/signup_send.php">
                    <input type="email" id="login" class="fadeIn second w-100" name="email" required
                           placeholder="Enter your email">
                    <input type="password" id="password" class="fadeIn third w-100" name="password" required
